...
map.getView().fit([12271215.909390, -798400.145193, 12358940.985262, -743730.672278], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Evakuasi Banjir Rob Kab. Demak</h2>';
        return titleElement;
    })(),
